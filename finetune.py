...
parser.add_argument('--datatype', default='2015',
                    help='datapath')
parser.add_argument('--datapath', default='/root/Work/data/kitti2015/training/',
                    help='datapath')
parser.add_argument('--epochs', type=int, default=1000,
                    help='number of epochs to train')
parser.add_argument('--loadmodel', default='./finalpass/checkpoint_15.tar',
                    help='load model')
parser.add_argument('--savemodel', default='./kittifinalpass/',
                    help='save model')
